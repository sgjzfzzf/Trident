...
// CHECK-SAME:    %[[TENSOR:.*]]: !llvm.struct<(i32, i32, i64)>, %[[SCALAR:.*]]: !llvm.struct<(i32, i32, i64)>, %[[ALPHA:.*]]: !llvm.struct<(i32, i32, i64)>) -> !llvm.struct<(i32, i32, i64)> {
...
// CHECK:         %[[NEG_SCALAR:.*]] = llvm.fneg %[[SCALAR_VALUE]] : f64
// CHECK:         llvm.call @aoti_torch_cuda_add_Scalar({{%.*}}, %[[NEG_SCALAR]], %[[ALPHA_VALUE]], {{%.*}})
