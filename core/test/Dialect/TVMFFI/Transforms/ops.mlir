...
// RUN: trident-core-opt %s -split-input-file -apply-object-ownership | FileCheck %s --check-prefix=OWNERSHIP
...
// OWNERSHIP: %[[KEEP:[a-zA-Z0-9_]+]] = arith.constant true
// OWNERSHIP: tvm_ffi.ObjectDecRef %[[ITEM]] : !tvm_ffi.tensor
// OWNERSHIP-NEXT: arithext.and_then.yield %[[KEEP]] : i1
