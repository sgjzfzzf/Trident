...
// CHECK-SAME:      : (!llvm.ptr, !llvm.ptr, !llvm.ptr) -> i32
// Load the result tensor handle from slot[6] (the extra return slot).
// CHECK:         %[[RES_GEP:.*]] = llvm.getelementptr %[[SLOTS]][6]
...
// CHECK-LABEL: llvm.func @__tvm_ffi_empty_like_wrapper(
...
tvm_ffi.func @empty_like_wrapper(%arg0: !torch.vtensor<[200,200,26],f64>) -> !torch.vtensor<[200,200,26],f64> {
