...
// CHECK:         %[[FUNC:.*]] = tvm_ffi.FunctionGetGlobal "ffi.Array" : !tvm_ffi.function
// CHECK-NEXT:    %[[RESULT:.*]] = tvm_ffi.FunctionCall %[[FUNC]](%arg0, %arg1) : (!tvm_ffi.tensor, !tvm_ffi.int) -> !tvm_ffi.array
...
// CHECK:         %[[FUNC:.*]] = tvm_ffi.FunctionGetGlobal "ffi.ArrayGetItem" : !tvm_ffi.function
// CHECK-NEXT:    %[[RESULT:.*]] = tvm_ffi.FunctionCall %[[FUNC]](%arg0, %arg1) : (!tvm_ffi.array, !tvm_ffi.int) -> !tvm_ffi.int
