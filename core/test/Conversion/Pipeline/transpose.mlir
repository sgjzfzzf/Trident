...
// CHECK: %[[NON_NULL:[a-zA-Z0-9_]+]] = llvm.icmp "ne" %[[HANDLE]], %[[NULL]] : !llvm.ptr
...
// CHECK: llvm.call @TVMFFIFunctionCall(%[[HANDLE]], %[[ARGS_COPY:[0-9]+]], %[[NARGS:[0-9]+]], %[[RET_SLOT:[0-9]+]]) : (!llvm.ptr, !llvm.ptr, i32, !llvm.ptr) -> i32
