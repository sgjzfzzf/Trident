...
// CHECK-NEXT: %[[CLONE:[a-zA-Z0-9_]+]], %[[CALL_SUCCESS:[a-zA-Z0-9_]+]] = tvm_ffi.FunctionCall %[[FUNC]](%arg0, %[[FORMAT]]) : (!tvm_ffi.tensor, !tvm_ffi.int) -> !tvm_ffi.tensor, i1
...
// CHECK-NEXT: %[[PACKED:[a-zA-Z0-9_]+]], %[[CALL_SUCCESS:[a-zA-Z0-9_]+]] = tvm_ffi.FunctionCall %[[FUNC]](%arg0, %[[DIM]], %[[KEEPDIM]]) : (!tvm_ffi.tensor, !tvm_ffi.int, !tvm_ffi.bool) -> !tvm_ffi.array, i1
...
// CHECK-NEXT: %[[VALUE0:[a-zA-Z0-9_]+]], %[[ITEM_CALL_SUCCESS0:[a-zA-Z0-9_]+]] = tvm_ffi.FunctionCall %[[ITEM_FUNC0]](%[[PACKED]], %[[IDX0]]) : (!tvm_ffi.array, !tvm_ffi.int) -> !tvm_ffi.tensor, i1
...
// CHECK-NEXT: %[[VALUE1:[a-zA-Z0-9_]+]], %[[ITEM_CALL_SUCCESS1:[a-zA-Z0-9_]+]] = tvm_ffi.FunctionCall %[[ITEM_FUNC1]](%[[PACKED]], %[[IDX1]]) : (!tvm_ffi.array, !tvm_ffi.int) -> !tvm_ffi.tensor, i1
