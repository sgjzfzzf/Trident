...
// CHECK: %[[FALSE_VALUE:[a-zA-Z0-9_]+]] = arith.constant false
// CHECK: %[[TRUE_VALUE:[a-zA-Z0-9_]+]] = arith.constant true
// CHECK: %[[RESULT:[a-zA-Z0-9_]+]] = scf.if %[[TRUE_VALUE]] -> (i1) {
// CHECK:   %[[NESTED_FIRST:[a-zA-Z0-9_]+]] = scf.if %[[TRUE_VALUE]] -> (i1) {
// CHECK:     %[[NESTED_SECOND:[a-zA-Z0-9_]+]] = scf.if %[[FALSE_VALUE]] -> (i1) {
...
// CHECK: %[[EMPTY_RESULT:[a-zA-Z0-9_]+]] = arith.constant true
