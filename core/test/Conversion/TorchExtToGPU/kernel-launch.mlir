...
// CHECK-DAG:  %[[CUDA_TYPE:[a-zA-Z0-9_]+]] = llvm.mlir.constant(2 : i32) : i32
// CHECK:      %[[SCALAR_VALUE:[a-zA-Z0-9_]+]] = llvm.extractvalue %[[SCAL_ARG]][2] : !llvm.struct<(i32, i32, i64)>
// CHECK:      %[[SCALAR_I32:[a-zA-Z0-9_]+]] = llvm.trunc %[[SCALAR_VALUE]] : i64 to i32
...
// CHECK:      %[[DEV_IDX_SLOT:[a-zA-Z0-9_]+]] = llvm.alloca %[[C1]] x i32 : (i64) -> !llvm.ptr
...
// CHECK:      args(%[[DATA_PTR]] : !llvm.ptr, %[[SCALAR_I32]] : i32, %[[ZERO]] : i64, %[[ZERO]] : i64)
